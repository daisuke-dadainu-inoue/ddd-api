...
public class CompanyUpdateByIdApi {

    private static final Logger LOGGER = LoggerFactory.getLogger(CompanyUpdateByIdApi.class);

    private static final String ERROR_EXCEPTION_001 = "error.controller.exception.001";

    private final CompanyUpdateByIdUseCaseIF useCase;

    @Inject
    public CompanyUpdateByIdApi(CompanyUpdateByIdUseCaseIF useCase) {
    ...
    public Response exec(@PathParam("companyId") int companyId, String body) {
        try {
            CompanyUpdateByIdInputData inputData = JsonConverter.fromJson(body, CompanyUpdateByIdInputData.class);
