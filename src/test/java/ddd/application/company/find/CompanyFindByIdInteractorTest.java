...
class CompanyFindByIdInteractorTest {

    @Inject
    CompanyFindByIdInteractor interactor;
    ...
    void init() throws Exception {
        ...
        Binder binder = new AbstractBinder() {
            ...
            protected void configure() {
                bindAsContract(CompanyFindByIdInteractor.class);
    ...
    void success_001() {
        try {
            ...
            CompanyFindByIdInputData inputData = new CompanyFindByIdInputData(1);
