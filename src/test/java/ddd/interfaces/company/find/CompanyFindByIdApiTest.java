...
import ddd.application.company.find.CompanyFindByIdInteractorMock;
import ddd.application.company.find.usecase.CompanyFindByIdUseCaseIF;
import ddd.interfaces.company.find.controller.CompanyFindByIdApi;

/**
 * ユーザー情報取得APIテスト
 */
public class CompanyFindByIdApiTest extends JerseyTest {
    ...
    protected Application configure() {
        return new ResourceConfig().register(CompanyFindByIdApi.class).register(new AbstractBinder() {
            @Override
            protected void configure() {
                bind(CompanyFindByIdInteractorMock.class).to(CompanyFindByIdUseCaseIF.class);
            }
        });
    }
